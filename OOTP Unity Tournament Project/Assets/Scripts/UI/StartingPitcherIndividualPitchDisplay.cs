...
public class StartingPitcherIndividualPitchDisplay : MonoBehaviour
{
...
#region LEAGUE_RATINGS
    ...
    {
        playerFastball = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].fastball;
        playerSlider = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].slider;
        playerCurveball = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].curveball;
        playerChangeup = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].changeup;
        playerCutter = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].cutter;
        playerSinker = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].sinker;
        playerSplitter = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].splitter;
        playerForkball = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].forkball;
        playerScrewball = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].screwball;
        playerCirclechange = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].circlechange;
        playerKnucklecurve = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].knucklecurve;
        playerKnuckleball = JsonReader.Instance.myStartingPitcherlist.starting_pitchers[currentPlayer].knuckleball;
    }
